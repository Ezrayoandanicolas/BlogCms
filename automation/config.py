...
class Config:
    ...
    OPENROUTER_FALLBACK_MODELS = list(filter(None, os.getenv("OPENROUTER_FALLBACK_MODELS", "google/gemma-4-31b-it:free,google/gemma-4-26b-a4b-it:free,google/gemma-3-27b-it:free,openrouter/auto").split(",")))
