@extends('theme::default.admin.layouts.guest')
...
@section('content')
    <div class="bg-white rounded-2xl shadow-xl p-8">
        ...
        <form action="{{ url('/admin/login') }}" method="POST">
            ...
            <button type="submit"
                    class="w-full bg-blue-600 text-white py-2.5 rounded-xl hover:bg-blue-700 text-sm font-medium transition-colors shadow-sm">
                Sign In
            </button>
        </form>
    </div>
