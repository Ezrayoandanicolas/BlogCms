...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8">
        <div class="bg-white rounded-sm shadow-sm border border-gray-100 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-3">
                <div class="w-10 h-10 rounded-sm bg-blue-50 text-red-600 flex items-center justify-center">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"/></svg>
                </div>
                <span class="text-xs font-medium text-red-600 bg-blue-50 px-2 py-0.5 rounded-full">{{ $stats['published'] }} published</span>
            </div>
        ...
        <div class="bg-white rounded-sm shadow-sm border border-gray-100 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-3">
                <div class="w-10 h-10 rounded-sm bg-purple-50 text-purple-600 flex items-center justify-center">
        ...
        <div class="bg-white rounded-sm shadow-sm border border-gray-100 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between mb-3">
                <div class="w-10 h-10 rounded-sm bg-orange-50 text-orange-600 flex items-center justify-center">
        ...
        <div class="bg-white rounded-sm shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-4">
                @foreach($domainStats as $ds)
                    <div class="flex items-center justify-between p-3 rounded-sm {{ $loop->first ? 'bg-blue-50' : 'bg-gray-50' }}">
                        <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white rounded-sm shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-2 gap-3">
                <a href="{{ url('/admin/posts/create') }}" class="flex items-center gap-3 p-3 rounded-sm bg-blue-50 text-red-700 hover:bg-red-100 transition-colors text-sm font-medium">
                ...
                <a href="{{ url('/admin/posts') }}" class="flex items-center gap-3 p-3 rounded-sm bg-gray-50 text-gray-700 hover:bg-gray-100 transition-colors text-sm font-medium">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                    View Posts
                </a>
                <a href="{{ url('/admin/comments?status=pending') }}" class="flex items-center gap-3 p-3 rounded-sm bg-orange-50 text-orange-700 hover:bg-orange-100 transition-colors text-sm font-medium">
                    <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    Moderate Comments
                </a>
                <a href="{{ url('/admin/settings') }}" class="flex items-center gap-3 p-3 rounded-sm bg-gray-50 text-gray-700 hover:bg-gray-100 transition-colors text-sm font-medium">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <div class="w-full bg-gray-100 rounded-full h-2">
                        ...
                        <div class="bg-red-600 h-2 rounded-full transition-all" style="width: {{ $pct }}%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex items-center justify-between text-sm mb-1">
