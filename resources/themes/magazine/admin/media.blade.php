...
@section('content')
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <label class="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-2.5 rounded-sm text-sm font-medium hover:bg-red-700 transition-colors shadow-sm cursor-pointer">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4" id="mediaGrid">
        @forelse($media as $m)
            <div class="bg-white rounded-sm shadow-sm border border-gray-100 overflow-hidden group relative">
